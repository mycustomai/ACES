...
from experiments.runners.batch_new.providers.gemini.monitor import (
    BatchStatus,
...
class TestGeminiProviderBatchMonitor:
    @patch("experiments.runners.batch_new.providers.gemini.monitor.genai")
    @patch("experiments.runners.batch_new.providers.gemini.monitor.storage")
    @patch("experiments.runners.batch_new.providers.gemini.monitor.vertexai")
